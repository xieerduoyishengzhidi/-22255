...
import "./RyukyuWavePage.css";

import heroWave from "./hero-wave.png";
import shuriCastle from "./shuri-castle.png";
import waveIcon from "./wave-icon.png";
import whaleBadge from "./whale-badge.png";
import lighthouse from "./lighthouse.png";
import bingataFrame from "./bingata-frame.png";
import aguBowl from "./agu-bowl.png";
        ...
        <div className="rw-container rw-hero-inner">
          ...
          <div className="rw-hero-illustration">
            <div className="rw-hero-image-wrap">
              <img src={heroWave} alt="浮世绘海浪与风狮爷" className="rw-floating" />
              <img
                src={whaleBadge}
                alt="庆良间蓝徽章"
        ...
        <div className="rw-container">
          ...
          <div className="rw-theme-grid">
            <div className="rw-theme-illustration" aria-hidden="true">
              <img src={shuriCastle} alt="首里城插画" />
              <img src={waveIcon} alt="" className="rw-theme-badge" />
            </div>
            <div className="rw-theme-copy">
              <h3>让卷轴式叙事带你走进琉球的心脏</h3>
              <p>
                区块之间穿插插画与真实感记录，读起来像 Mailchimp
                垂直叙事，却又保留浮世绘的分镜感。跟着视觉节奏，你会在海浪声中穿梭首里城、古宇利大桥、嘉嘉岛与国际通。
              </p>
              <ul>
      ...
      <section className="rw-band rw-itinerary-band" id="itinerary">
        <div className="rw-container">
          ...
          <div className="rw-itinerary-stamp">
            <img src={lighthouse} alt="残波岬灯塔插画" />
            <div>
              <p>行程亮点分镜</p>
            ...
            {guides.map((guide) => (
              <article className="rw-guide-card" key={guide.name}>
                <div className="rw-guide-photo" aria-hidden="true">
                  <img src={guide.photo} alt={`${guide.name} 的插画`} />
                </div>
